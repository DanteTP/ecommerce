...
module.exports = {
    ...
    createuser : async (req,res,next) =>{
        ...
        res.render('user',{title:'express',user:user,errors:'false',screen:'home',addresserror:'false'})
    }},
    ...
    res.render('user',{title:'express',user:user,errors:'false',screen:'home',usererrors:'false',passerrors:'false',addresserror:'false',data:'false'})
    },
    edituser: async (req,res,next) =>{
    let errors = validationResult(req)
    if(!errors.isEmpty()){
        let user = await db.Users.findByPk(req.body.Id, {include:['direccionesusuario']})
    ...
    createaddress: async (req,res,next)=>{
        ...
        if(!errors.isEmpty()){ 
            ...
            res.render('user',{title:'express',user:user,screen:'adderror',usererrors:'false',passerrors:'false',addresserror:errors.errors,data:data})
        }else{
            let data = {
                Adress:req.body.Adress,
                City:req.body.City,
            ...
            let user = await db.Users.findByPk(req.body.User_Id, {include:['direccionesusuario']})
            res.render('user',{title:'express',user:user,screen:'addsuccess',usererrors:'false',passerrors:'false',addresserror:'false'})
    }},
    editaddress: async(req,res,next)=>{
        ...
        let user = await db.Users.findByPk(req.body.User_Id, {include:['direccionesusuario']})
        res.render('user',{title:'express',user:user,screen:'editaddresssucc',usererrors:'false',passerrors:'false',addresserror:'false'})
    },
